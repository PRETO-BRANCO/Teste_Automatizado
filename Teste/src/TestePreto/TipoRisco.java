	...
	public String criar () {
		...
		try {
			...
			BufferedWriter bw = new BufferedWriter(fw);
				bw.write("Tempo de resposta ao clicar no botão Novo no cad. de Tipo de Risco: " + segundos + " segundo(s).\n");
				bw.close(); 
				fw.close();
		}catch (IOException e) {
			e.printStackTrace();
		...
		if (message2.equals("Operação realizada com sucesso.")){
			return "tpRisco Salvo";
		}if (message2.equals("Já existe um Tipo de Risco cadastrado com essa descrição. Favor verificar.")){
