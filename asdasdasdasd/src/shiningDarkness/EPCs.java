...
public class EPCs {
	...
	public EPCs(WebDriver driver, WebDriverWait wdw, Signal horizon, Long starttime, String ed) {
		this.driver = driver;
		this.wdw = wdw;
	...
	public String criar() {
		...
		driver.findElement(By.xpath("//a [@href='medidas_controle.html']")).click();
		...
		epc =  this.horizon.generateString(35);

		driver.findElement(By.id("descricao")).sendKeys(epc);
		driver.findElement(By.xpath("//input [@ng-model='medidaControle.catQuimico']")).click();
		driver.findElement(By.xpath("//input [@ng-model='medidaControle.catFisico']")).click();
		driver.findElement(By.xpath("//input [@ng-model='medidaControle.catBiologico']")).click();
		driver.findElement(By.xpath("//input [@ng-model='medidaControle.catErgonomico']")).click();
		driver.findElement(By.xpath("//input [@ng-model='medidaControle.catMecanico']")).click();
		...
		System.out.println("EPCs " + epc + "				" + horizon.time(starttime));
		return epc;
	}
	...
	public void editar() {
		...
		driver.findElement(By.id("iDescricao")).sendKeys(epc);
		...
		driver.findElement(By.xpath("//td [contains(text(),'" + epc +"')]")).click();
		...
		System.out.println("EPC+ " + epc + "				" + horizon.time(starttime));	
	}
