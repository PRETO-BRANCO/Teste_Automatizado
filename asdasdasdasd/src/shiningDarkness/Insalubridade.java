...
public class Insalubridade {
	...
	public Insalubridade(WebDriver driver, WebDriverWait wdw, Signal horizon, Long starttime,String ed,String unidade) {
		this.driver = driver;
		this.wdw = wdw;
	...
	public void criar() {
		...
		driver.findElement(By.linkText("Insalubridade")).click();
		...
		driver.findElement(By.xpath("//input [@formcontrolname='dataBase']")).sendKeys("28022019");
		...
		this.horizon.waitLoad();
		wdw.until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//apls-radio-button [@value='2']"))));
		...
		this.horizon.waitLoad();
		wdw.until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//apls-checkbox [@formcontrolname='qualitativoUmidade']"))));

		lista = driver.findElements(By.xpath("//div [@class='apls-checkbox-inner-container'  and (ancestor::insa-metodologia[contains(@class,'ng-star-inserted')])]"));
		...
		driver.findElement(By.xpath("//button [@aplstooltip='Adicionar'  and (ancestor::insa-colaboradores[contains(@class,'ng-star-inserted')])]")).click();		
	...
	public void editar() {
		...
		driver.findElement(By.xpath("//span [@aplstooltip='Excluir' and (ancestor::insa-colaboradores[contains(@class,'ng-star-inserted')])]")).click();
