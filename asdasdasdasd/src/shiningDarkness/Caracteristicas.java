...
public class Caracteristicas {
	...
	public Caracteristicas(WebDriver driver, WebDriverWait wdw,Signal horizon,Long starttime,String ed,String unidade) {		
		this.driver = driver;
		this.wdw = wdw;		
	...
	public String criar() {
		...
		driver.findElement(By.id("lb-cadastro-caracteristicas")).click();
		...
		caracteristica = this.horizon.generateString(20);
		...
		driver.findElement(By.xpath("//button [@class='multiselect dropdown-toggle btn btn-default']")).click();
		driver.findElement(By.id("i-descricao-cadastro")).sendKeys(caracteristica);
		...
		System.out.println("Caracteristica " + caracteristica + "					" + horizon.time(starttime));	
	...
	public void editar() {
		...
		driver.findElement(By.id("i-descricao-filtro")).sendKeys(caracteristica);

		driver.findElement(By.id("bt-filtrar")).click();

		this.horizon.waitLoad();

		driver.findElement(By.xpath("//td [contains(text(),'"+ caracteristica +"')]")).click();
