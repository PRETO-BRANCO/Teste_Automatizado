...
public class Destino {
	...
	public Destino(WebDriver driver, WebDriverWait wdw,Signal horizon,Long starttime,String ed,String unidade) {		
		this.driver = driver;
		this.wdw = wdw;		
	...
	public String criar() {
		...
		driver.findElement(By.id("lb-cadastro-destino")).click();
		...
		destino = this.horizon.generateString(20);
		...
		driver.findElement(By.xpath("//button [@class='multiselect dropdown-toggle btn btn-default']")).click();
		driver.findElement(By.id("i-descricao-cadastro")).sendKeys(destino);
		...
		System.out.println("Destino " + destino + "						" + horizon.time(starttime));	
		return destino;
	}
	...
	public void editar() {
		...
		driver.findElement(By.id("i-descricao-filtro")).sendKeys(destino);

		driver.findElement(By.id("bt-filtrar")).click();

		this.horizon.waitLoad();

		driver.findElement(By.xpath("//td [contains(text(),'"+ destino +"')]")).click();
