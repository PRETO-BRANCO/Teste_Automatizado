...
public class Situacao {
	...
	public Situacao(WebDriver driver, WebDriverWait wdw,Signal horizon,Long starttime,String ed,String unidade) {		
		this.driver = driver;
		this.wdw = wdw;		
	...
	public String criar() {
		...
		driver.findElement(By.id("lb-cadastro-situacao")).click();
		...
		situacao = this.horizon.generateString(15);
		...
		driver.findElement(By.xpath("//button [@class='multiselect dropdown-toggle btn btn-default']")).click();
		driver.findElement(By.id("i-descricao-cadastro")).sendKeys(situacao);
		...
		System.out.println("Situação " + situacao + "						" + horizon.time(starttime));	
		return situacao;
	}
	...
	public void editar() {
		...
		driver.findElement(By.id("i-descricao-filtro")).sendKeys(situacao);

		driver.findElement(By.id("bt-filtrar")).click();

		this.horizon.waitLoad();

		driver.findElement(By.xpath("//td [contains(text(),'"+ situacao +"')]")).click();
